...
public class LikeController {
    ...
    public ResponseEntity<ActionResponse<Void>> like(@AuthenticationPrincipal UUID userId,
    ...
    @DeleteMapping
    @PreAuthorize(RolePermission.USER)
    public ResponseEntity<ActionResponse<Void>> unlike(@AuthenticationPrincipal UUID userId,
                                                       @Valid @RequestBody LikeRequest request) {
