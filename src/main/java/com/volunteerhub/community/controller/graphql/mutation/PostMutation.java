...
public class PostMutation {
    ...
    @MutationMapping
    public ModerationResponse createPost(@AuthenticationPrincipal UUID userId,
                                         @Valid @Argument CreatePostInput input) {
        return postService.createPost(userId, input);
    }

    @MutationMapping
    public ModerationResponse editPost(@AuthenticationPrincipal UUID userId,
                                       @Valid @Argument EditPostInput input) {
        return postService.editPost(userId, input);
    }

    @MutationMapping
    public ModerationResponse deletePost(@AuthenticationPrincipal UUID userId,
